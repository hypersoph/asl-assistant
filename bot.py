...
async def help(ctx):
    ...
    embed.add_field(name = "Invite me to your server", value = "[Use this invite link](https://discord.com/oauth2/authorize?client_id=676113360642899988&scope=bot&permissions=139586825281)")
    await ctx.send(embeds = embed)
